...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="card card-blog-post <?php echo esc_attr($image_alignment_class); ?>">
        <?php
        if ($image_alignment == 'full-image' || $image_alignment == 'masonry') {
        ?>
        ...
        <div class="card_body">
            <?php
            if ($image_alignment == 'normal') {
            ?>
                <div class="fairy-metas">
                    <?php
                    echo fairy_get_category();
            ...
            if ($fairy_theme_options['fairy-content-show-from'] == 'excerpt') {
                $entry_content_class .= ' entry-content-excerpt';
            }
            ?>
            <div class="<?php echo $entry_content_class; ?>">
                ...
                if (is_singular()) {
                    the_content(
                        sprintf(
                            wp_kses(
                                ...
                                __('Continue reading<span class="screen-reader-text"> "%s"</span>', 'fairy-lite'),
                                array(
                                    'span' => array(
                                        'class' => array(),
                                    ),
                    ...
                    wp_link_pages(
                        array(
                            'before' => '<div class="page-links">' . esc_html__('Pages:', 'fairy-lite'),
                            'after' => '</div>',
                        )
                    );
                } else {
